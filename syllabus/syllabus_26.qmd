...
grade_table <-
  data.table(
    title = c("In-class assignments (4 assignments)", "Total"),
    score = c("100%", "100%")
  )
...
+ **In-class assignments**: There will be 4 in-class assignments, and they are the entire course grade. Each is worked on and submitted during class.
